...
# # Parse the raw log JSON file into a cleaned output JSON file by applying a chosen
# # parsing logic for further analysis. The output organizes actions by session.
...
#         all_logs=coauthor_logs_by_session[session],
#         last_action=None
#     )
...
# level_2_actions_per_session = parse_level_2_actions(level_1_actions_per_session,
#                                                     similarity_fcn=get_spacy_similarity)
...
# level_3_actions_per_session = parse_level_3_actions(level_2_actions_per_session,
#                                                     similarity_fcn=get_spacy_similarity)
...
# action_type_with_priority_per_session = action_type_priority_sort(custom_priority_list, level_3_actions_per_session)
